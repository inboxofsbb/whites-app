...
import { TArchiveIcon } from "../icons/TArchiveIcon";
import { TClassesNavigationIcon } from "../icons/TClassesNavigationIcon";
import { THomeIcon } from "../icons/THomeIcon";
import { TInvoiceIcon } from "../icons/TInvoiceIcon";
import TPaymentsIcon from "../icons/TPaymentsIcon";
import { TSessionsIcon } from "../icons/TSessionsIcon";
import { TStudentGroupNavigationIcon } from "../icons/TStudentGroupNavigationIcon";
import { TStudentNavigationIcon } from "../icons/TStudentsNavigationIcon";
import { TTeachersIcon } from "../icons/TTeachersIcon";
...
export default function MainLayout({ children }: Props) {
    ...
    const { studentIdAtom, setStudentIdAtom }: any = useStudent();
    ...
    return (<>
        ...
        <main>
            <div className="max-w-6xl   mx-auto pt-4 px-2 sm:px-6 lg:px-8">
                {children}
            </div>
