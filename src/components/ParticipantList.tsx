...
export default function ParticipantList({
  ...
  const setBoardData = async () => {
    try {
      ...
      cob.ackExplicit();
      cob.deliverLast();
      const s1 = await js?.subscribe(`wb.${room?.name}.*`, cob);
      (async (data) => {
  ...
  return (
    <div className="!bg-[#F1F5F9] h-[100%] relative flex flex-col justify-between !z-30">
      ...
      {isHost && (
        <div className="bg-[#D9D9D9] w-full  h-[15%] max-h-[76px] flex items-center justify-center ">
          <div
